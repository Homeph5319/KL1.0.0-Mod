...
.field private static ajH:Landroid/os/PowerManager$WakeLock;

.field private static ajJ:I

.field private static final ajK:Ljava/util/Random;

.field private static final ajL:I


# instance fields
.field private final ajI:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajJ:I

    new-instance v0, Ljava/util/Random;

    invoke-direct {v0}, Ljava/util/Random;-><init>()V

    sput-object v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajK:Ljava/util/Random;
    ...
    sput v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajL:I

    sget-object v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajK:Ljava/util/Random;
...
.method private constructor <init>(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/google/android/gcm/GCMBaseIntentService;->ajI:[Ljava/lang/String;
...
.method static a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajH:Landroid/os/PowerManager$WakeLock;
    ...
    sput-object v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajH:Landroid/os/PowerManager$WakeLock;
...
.method private static getName(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget v1, Lcom/google/android/gcm/GCMBaseIntentService;->ajJ:I

    add-int/lit8 v1, v1, 0x1

    sput v1, Lcom/google/android/gcm/GCMBaseIntentService;->ajJ:I
...
.method public final onHandleIntent(Landroid/content/Intent;)V
    ...
    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->p(Landroid/content/Context;)V
    ...
    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->u(Landroid/content/Context;)V

    invoke-static {v1, v0}, Lcom/google/android/gcm/GCMRegistrar;->d(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/google/android/gcm/GCMBaseIntentService;->l(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->s(Landroid/content/Context;)Ljava/lang/String;

    invoke-virtual {p0, v1}, Lcom/google/android/gcm/GCMBaseIntentService;->i(Landroid/content/Context;)V
    :try_end_2
    ...
    :try_start_3
    sget-object v2, Lcom/google/android/gcm/GCMBaseIntentService;->ajH:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->v(Landroid/content/Context;)I

    move-result v2

    div-int/lit8 v0, v2, 0x2

    sget-object v3, Lcom/google/android/gcm/GCMBaseIntentService;->ajK:Ljava/util/Random;
    ...
    sget v0, Lcom/google/android/gcm/GCMBaseIntentService;->ajL:I
    ...
    :cond_a
    :try_start_8
    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->r(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-static {v1}, Lcom/google/android/gcm/GCMRegistrar;->o(Landroid/content/Context;)V

    goto/16 :goto_0

    :cond_b
    iget-object v0, p0, Lcom/google/android/gcm/GCMBaseIntentService;->ajI:[Ljava/lang/String;
